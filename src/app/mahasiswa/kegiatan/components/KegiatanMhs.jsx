    ...
    <div>
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 p-4 border-b">
          <h3 className="text-base md:text-lg font-semibold flex items-center text-gray-800">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            ...
            <div className="relative w-full sm:w-72">
              <input
                ...
                className="pl-10 pr-3 py-2 border rounded-lg text-sm w-full 
            ...
            <button
              ...
              className="bg-blue-600 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-700 transition text-sm flex items-center justify-center"
            >
